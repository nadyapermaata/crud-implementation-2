<?php
    ...
    $pdf->Cell(272, 7, "SMAN 5 SURABAYA", 0, 1, "C");
    ...
    if ($result) {
        ...
        $pdf->Cell(64, 6, "Sekolah Asal", 1, 0, "C");
        $pdf->Cell(32, 6, "Agama", 1, 0, "C");
        $pdf->Cell(32, 6, "Jenis Kelamin", 1, 1, "C");
        ...
        while($siswa = mysqli_fetch_array($result)) {
            ...
            $pdf->Cell(64, 6, $siswa["sekolah_asal"], 1, 0, "C");
            $pdf->Cell(32, 6, $siswa["agama"], 1, 0, "C");
            $pdf->Cell(32, 6, $siswa["jenis_kelamin"], 1, 1, "C");
